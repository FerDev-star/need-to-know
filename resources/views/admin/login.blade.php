...
@section('content')
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
        ...
        <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
            ...
            @endif
            <form class="space-y-6" action="{{ route('authenticate') }}" method="GET">
                @csrf
                <div>
                    <label for="username" class="login-label">Username</label>
                    <div class="mt-2">
                        <input id="username" name="name" type="text" class="w-full">
                    </div>
            ...
            <br>
            <div>
                <button class="btn w-full"><a href="{{ route('register.page') }}">Register</a</button>
            </div>
            <br>
            <div>
